...
DROP POLICY IF EXISTS "super admins can read all brands" ON brands;
DROP POLICY IF EXISTS "super admins can insert brands" ON brands;
DROP POLICY IF EXISTS "super admins can read all brand memberships" ON brand_memberships;
DROP POLICY IF EXISTS "super admins can insert brand memberships" ON brand_memberships;
...
CREATE POLICY "super admins can read all brands" ON brands
  FOR SELECT
  USING (
    EXISTS (
      SELECT 1 FROM profiles p
...
CREATE POLICY "super admins can insert brands" ON brands
  FOR INSERT
  WITH CHECK (
    EXISTS (
      SELECT 1 FROM profiles p
...
CREATE POLICY "super admins can read all brand memberships" ON brand_memberships
  FOR SELECT
  USING (
    EXISTS (
      SELECT 1 FROM profiles p
...
CREATE POLICY "super admins can insert brand memberships" ON brand_memberships
  FOR INSERT
  WITH CHECK (
    EXISTS (
      SELECT 1 FROM profiles p
