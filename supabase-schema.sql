...
-- Leaderboard view - shows top scores per game
...
-- Players: Allow anyone to read, authenticated users can insert/update
...
-- Games: Allow anyone to read, authenticated users can insert/update
...
-- Scores: Allow anyone to read and insert
...
-- ============================================
-- 
-- To make this more secure, you can:
-- 1. Replace "true" in RLS policies with auth.uid() checks
-- 2. Add user authentication using Supabase Auth
-- 3. Restrict updates/deletes to record owners
--
